...
(function(root){
'use strict';
const C={version:4,title:'华东智行 · 出海决策室',days:25};
C.people={
...
C.tasks=[
 ...
 O('bridge','借入20万元项目周转','支付1万元办理费用；项目结束归还22万元，先核实未来回款。',0,{bridge:true}),O('stage','与客户争取阶段预付','需已签合同，支付1万元办理费用后提前收到10万元；最终回款相应减少。',0,{earlyPay:true},{requireFlag:'signed'})],{remote:true,night:true,topics:['value','coord']}),
...
root.HDContent=C;if(typeof module!=='undefined')module.exports=C;
